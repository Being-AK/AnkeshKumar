...
const NAV_LINKS = [
  ...
  { name: 'PDF Toolkit', href: '#pdf-toolkit' },
...
const Header: React.FC<HeaderProps> = ({ darkMode, toggleTheme, onOpenMagic }) => {
  ...
  return (
    <>
      ...
      <header 
        className={`fixed w-full top-0 z-50 transition-all duration-500 ease-in-out motion-reduce:transition-none ${
          scrolled 
      ...
      >
        <div className="container mx-auto px-6 flex justify-between items-center relative">
          ...
          <div className="hidden md:flex items-center gap-4 xl:gap-6">
            <nav className="flex gap-4 xl:gap-6" aria-label="Main navigation">
              {NAV_LINKS.map((link) => {
