...
export default function PdfToImagesTool({ onClose }: PdfToImagesToolProps) {
  ...
  // Lazy-load PDF.js from cdnjs to avoid Vite bundler problems and keep initial bundle tiny
  const loadPdfJsLibrary = (): Promise<any> => {
    ...
    return new Promise((resolve, reject) => {
      ...
      script.onerror = () => {
        setLibLoading(false);
        reject(new Error('Failed to load PDF.js engine from secure CDN. Please check your network connection.'));
      };
